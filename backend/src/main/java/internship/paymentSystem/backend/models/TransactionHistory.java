...
public class TransactionHistory extends TransactionEntity {
    ...
    public TransactionHistory(TypeTransactionEnum type, ActionTransactionEnum action, BigDecimal amount, Long accountID,
    ...
    public TransactionHistory(TypeTransactionEnum type, ActionTransactionEnum action, BigDecimal amount, Long accountID,
                       ...
                       StatusEnum status, StatusEnum nextStatus) {
        super(type, action, amount, accountID, targetAccountID, targetIban, bankName, nameReceiver, status, nextStatus);
    }
